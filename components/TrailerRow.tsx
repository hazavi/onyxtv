...
export default function TrailerRow({ trailers }: Props) {
  ...
  return (
    <section className="mt-14 group/row relative">
      ...
      <div className="relative">
        ...
        <div
          ref={rowRef}
          className="carousel-row no-scrollbar touch-pan-x gap-4"
        >
          {trailers.map((v) => (
            <div key={v.id} className="shrink-0 w-[320px] sm:w-[400px]">
